/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/examples/worker-configuration.d.ts` (hash: ba2bc37c416df5068b7bf7c2d109e6f3)
// Runtime types generated with workerd@1.20260611.1 2024-12-05 
interface __BaseEnv_Env {
	WORKFLOW_EVENTS: DurableObjectNamespace<import("./index").WorkflowEvents>;
	DEMO_WORKFLOW: Workflow<Parameters<import("./index").DemoWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "WorkflowEvents";
	}
